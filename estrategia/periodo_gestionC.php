...
<html lang="es">
  ...
  <body>
    <div id="container" class="effect mainnav-lg">
      ...
      <div class="boxed">
        ...
        <div id="content-container">
          ...
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <div id="page-title">
            <h1 class="page-header text-overflow">Periodo Gestión Cedente</h1>
          </div>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End page title-->
          <!--Breadcrumb-->
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Periodo Gestión Cedente</li>
          </ol>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End breadcrumb-->
          <!--Page content-->
                    ...
                    <div class="panel-body">
                      ...
                      <!-- INICIO CONTENIDO PRINCIPAL -->
                        ...
                        <div class="table-responsive">
                          <div class="row">
                            <div class="col-sm-3">
                              <button style="margin: 10px 0;" id="seleccionarCedente" class="btn btn-success btn-block">Seleccione Mandante</button>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-sm-3">
                              <button style="margin: 10px 0;" id="AddPeriodo" class="btn btn-primary btn-block" disabled>Agregar Periodo</button>
                            </div>
                          </div>
    ...
    <script id="templateMandanteCedente" type="text/template">
      <div class="row">
        <div class="col-md-12">
          <form class="form-horizontal">
            <div class="row">
