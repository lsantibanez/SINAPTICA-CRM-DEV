                                            ...
                                            <tr v-for="(campo, index) in subQueries.rows" :key="index">
                                                <td style="text-align: center;">
                                                    <button type="button" class="btn btn-sm btn-danger"
                                                            @click.prevent="removeRow(index)" v-if="index > 0">
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                                </td>
                                                <td style="text-align: center;">
                                                    <select class="form-control" name="action[]" :id="'action_'+index"
                                                            v-model="campo.action" v-if="index > 0">
                                                        <option v-for="(actionItem, aIndex) in campo.actionList"
                                                                :key="aIndex" :value="actionItem.value">
                                                            {{ actionItem.label }}
                                                        </option>
                                                    </select>
                                                    <span v-else>&nbsp;</span>
                                                ...
                                                <td style="text-align: left;">
                                                    <select class="form-control" name="table[]" :id="'table_'+index"
                                                            v-model="campo.table" @change="filterDataTo(index)">
                                                ...
                                                <td>
                                                    <select class="form-control" name="colum[]" :id="'column_'+index"
                                                            v-model="campo.column"
                                                            :disabled="columns[index] === undefined || !columns[index].length"
                                                            @change="filterDataTo(index, 'logics')">
                                                        <option value=""> -- Seleccione --</option>
                                                        <option v-for="column in columns[index]" :value="column.name"
                                                                v-if="columns[index] !== undefined">{{ column.title }}
                                                        </option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <select class="form-control" name="logic[]" @click="verDatos"
                                                            :id="'logic_'+index" v-model="campo.logic"
                                                            :disabled="campo.logicList === undefined || !campo.logicList.length">
                                                        <option value=""> -- Seleccione --</option>
                                                        <option v-for="logica in campo.logicList" :value="logica.value">
                                                            {{ logica.title }}
                                                        </option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="date" name="value" id="value"
                                                           class="form-control form-control-sm col-6"
                                                           v-model="campo.value" :disabled="campo.logic === ''"
                                                           v-if="campo.type === 'date'">
                                                    <select name="value" id="value" class="form-control"
                                                            v-model="campo.value" :disabled="campo.logic === ''"
                                                            v-else-if="campo.type === 'list'" :multiple="campo.multi">
                                                        <option value="" v-if="!campo.multi"> -- Seleccione --</option>
                                                        <option v-for="(item,index) in campo.itemsList" :key="index"
                                                                :value="item.id" v-if="campo.itemsList.length">
                                                            {{ item.name }}
                                                        </option>
                                                    </select>
                                                    <input type="text" name="value" id="value"
                                                           class="form-control form-control-sm col-6"
                                                           v-model="campo.value" :disabled="campo.logic === ''" v-else>
                                                </td>
                                                <td>
                                                    <div v-if="['btw','nbtw'].includes(campo.logic.split('$')[0])">
                                                        <input type="date" name="value2" id="value2"
                                                               class="form-control form-control-sm col-6"
                                                               v-model="campo.value2" :disabled="campo.logic === ''"
                                                               v-if="campo.type === 'date'">
                                                        <select name="value2" id="value2" class="form-control"
                                                                v-model="campo.value2" :disabled="campo.logic === ''"
                                                                v-else-if="campo.type === 'list'"
                                                                :multiple="campo.multi">
                                                            <option value="" v-if="!campo.multi"> -- Seleccione --
                                                            </option>
                                                            <option v-for="(item,index) in campo.itemsList" :key="index"
                                                                    :value="item.id" v-if="campo.itemsList.length">
                                                                {{ item.name }}
                                            ...
                                            <tr>
                                                <td style="text-align: center;">
                                                    <button type="button" class="btn btn-sm btn-success"
                                                            title="Agregar condición" @click.prevent="addRow"
                                                            v-if="subQueries.rows.length <= 3">
                                                ...
                                                <td colspan="2">
                                                    <input type="text" class="form-control form-control-sm"
                                                           ...
                                                           :length="37 - nombreProyecto.length"
                                                           :maxlength="37 - nombreProyecto.length"
                                                           v-model="subQueries.name">
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-primary"
                                                            @click.prevent="creaResultado"
                                                            :disabled="subQueries.name === ''">Crear segmento
                                                    </button>
                                                </td>
                                                <td>&nbsp;</td>
                                            </tr>
                                    ...
                                    <div class="panel">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-horizontal" v-if="showFormAssignation">
                                                <div class="form-group">
                                                    <label for="inputPassword3"
                                                           class="col-sm-2 control-label">Segmento:</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label for="inputPassword3"
                                                           class="col-sm-2 control-label">Servicio:</label>
                                                    <div class="col-sm-5">
                                                        <select v-model="actionData.service" class="form-control"
                                                                @change="setSeviceActive($event)">
                                                            <option value="">-- Seleccione --</option>
                                                            <option value="email">Correos</option>
                                                            <option value="sms">Sms</option>
                                                            <option v-for="servicio in serviceList" :value="servicio.id"
                                                                    :key="servicio.id">{{ servicio.name }}
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <!-- Inicio Formulario de correo -->
                                                    <div class="col-md-12" v-if="isFormEmail">
                                                        <h4 class="my-20">Asignar al servicio email</h4>
                                                        <div class="form-group">
                                                            <label for="inputPassword3" class="col-sm-3 control-label">Nombre
                                                                de carga/campaña:</label>
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"
                                                                          id="basic-addon1"><?php echo $nombreProyecto ?> - </span>
                                                                    <input type="text" class="form-control"
                                                                           v-model="formEmail.campaign.name"
                                                                           :length="37 - nombreProyecto.length"
                                                                           :maxlength="37 - nombreProyecto.length">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           v-model="formEmail.campaign.subject">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputPassword3" class="col-sm-3 control-label">Correo
                                                                de respuesta:</label>
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"
                                                                    ...
                                                                    <input type="email" class="form-control"
                                                                           v-model="formEmail.campaign.emailResponse">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           v-model="formEmail.campaign.sender">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-md-12 mb-20">
                                                                <label for="template_id" class="col-sm-3 control-label">Seleccione
                                                                    Plantilla</label>
                                                                <div class="col-sm-9 d-flex gap-10 pl-7 pr-0">
                                                                    <select id="template_id"
                                                                            v-model="formEmail.campaign.template_id"
                                                                            @change="findTemplate"
                                                                            class="form-control">
                                                                        <option value="">-- Seleccione --</option>
                                                                        <option v-for="template in formEmail.templates"
                                                                                :value="template.id" :key="template.id">
                                                                            {{ template.name }}
                                                                        </option>
                                                                    </select>
                                                                    <button v-if="formEmail.templateSelected"
                                                                            type="button"
                                                            ...
                                                            <div class="col-md-12 mb-20"
                                                                 v-if="formEmail.templateSelected && formEmail.customVariables">
                                                                <label for="customVariables"
                                                                       class="col-sm-2 control-label">Variables de la
                                                                    plantilla</label>
                                                                <div class="col-sm-5 d-flex gap-10"
                                                                >
                                                                    <span class="btn btn-sm btn-primary cursor-auto"
                                                                          v-for="(item,index) in formEmail.customVariables"
                                                                          :key="index">{{item}}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <!-- Modal -->
                                                    <div id="templatePreviewModal" class="modal fade" tabindex="-1"
                                                         role="dialog">
                                                        <div class="modal-dialog modal-xl">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h4 class="modal-title">Vista previa de la
                                                                        plantilla</h4>
                                                                </div>
                                                                <div class="modal-body text-center">

                                                                    <img v-if="formEmail.templateSelected && formEmail.templateSelected.urlPreview"
                                                                         :src="formEmail.templateSelected.urlPreview"
                                                                         alt="Vista previa de la plantilla"
                                                                         class="img-responsive center-block">
                                                                    <p v-else>No hay imagen disponible.</p>
                                                                    <form @submit="selectTemplate(formEmail.templateSelected, $event)"
                                                                          class="m-0">
                                                                        <button type="submit"
                                                ...
                                                <div id="dialerService" v-if="actionData.service === 'discador'">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"
                                                                      id="basic-addon1"><?php echo $nombreProyecto ?> - </span>
                                                                <input type="text" class="form-control"
                                                                       v-model="actionData.params.name"
                                                                       :length="37 - nombreProyecto.length"
                                                                       :maxlength="37 - nombreProyecto.length">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <select name="" id=""
                                                                    v-model="actionData.params.dealer_type"
                                                                    class="form-control">
                                                                <option value="">-- Seleccione --</option>
                                                                <option v-for="dialerType in serviceActive.params.dealer_type"
                                                                        :value="dialerType.id" :key="dialerType.id">
                                                                    {{ dialerType.name }}
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <template v-if="hasTypeDealerParams().length">
                                                        <div class="form-group"
                                                             v-for="typeDealer in hasTypeDealerParams()"
                                                             :key="typeDealer.id">
                                                            <label for="inputPassword3" class="col-sm-2 control-label">{{ typeDealer.label
                                                                }}:</label>
                                                            <div class="col-sm-4">
                                                                <select v-model="actionData.params.intensity"
                                                                        class="form-control">
                                                                    <option v-for="dialerTypeParam in typeDealer.items"
                                                                            :value="dialerTypeParam.id"
                                                                            :key="dialerTypeParam.id">
                                                                        {{ dialerTypeParam.name }}
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputPassword3" class="col-sm-2 control-label">Asignar
                                                            a:</label>
                                                        <div class="col-sm-4">
                                                            <select v-model="actionData.params.assign_to"
                                                                    class="form-control">
                                                    ...
                                                    <div class="form-group"
                                                         v-if="actionData.params.assign_to === 'AGENTS'">
                                                        <label for="inputPassword3" class="col-sm-2 control-label">Agente(s):</label>
                                                        <div class="col-sm-4">
                                                            <div class="checkbox"
                                                                 v-for="(agent,aIndex) in serviceActive.params.agents"
                                                                 :key="agent.id">
                                                                <label>
                                                                    <input type="checkbox" :value="agent.usuario"
                                                                           v-model="actionData.params.agents">
                                                                    {{ agent.nombre }}
                                                                </label>
                                                            </div>
                                                        </div>
                                                ...
                                                <template
                                                        v-if="assosiationData.service !== null && assosiationData.service.params.length">
                                                    <div class="form-group"
                                                         v-for="(parametro, pIndex) in assosiationData.service.params"
                                                         :key="pIndex">
                                                        <label for="inputPassword3"
                                                               class="col-sm-2 control-label">{{ parametro.label
                                                            }}:</label>
                                                        <div class="col-sm-4">
                                                            <select name="" id="" v-model="parametro.value"
                                                                    class="form-control">
                                                                <option value="">-- Seleccione --</option>
                                                                <option v-for="itemParametro in parametro.items"
                                                                        :value="itemParametro.id"
                                                                        :key="itemParametro.id">{{ itemParametro.name }}
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group" v-if="actionData.service !== ''">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <button type="button" class="btn btn-success"
                                                                @click.prevent="sendAssignation($event)">Enviar
                                                        </button>
                                                    </div>
                                                </div>
                                            </div><!-- form -->
                                            ...
                                            <div class="col-md-12" v-if="messageAssign.text !==''">
                                                <div class="alert" :class="'alert-' + messageAssign.type" role="alert"
                                ...
                                <div class="panel-body">
                                    <table class="table table-sm">
                                        ...
                                        <tr v-for="(segmento, sIndex) in segmentList" :key="sIndex">
                                            ...
                                            <td style="text-align:right;">
                                                <button type="button" class="btn btn-success"
                                                        v-if="parseInt(segmento.deudas) > 0"
                                                        @click.prevent="assignation(segmento, $event)">
        ...
        methods: {
            ...
            setSeviceActive: function (e) {
                ...
                if (this.serviceList.length && value !== '') {
                    ...
                    if (value === 'email') {
                        ...
                        this.formEmail.campaign.query_id = this.segmentList[0].id
                        this.getTemplates();
                        return;
                    }
            ...
            filterDataTo: function (index, section = 'columns') {
                ...
                if (section === 'columns') {
                    ...
                    if (valores !== undefined) {
                        ...
                        this.columns[index] = valores.columns?.map(c => ({
                            name: c.name,
                            title: c.title,
                            type: c.type,
                            items: c.items,
            ...
            sendAssignation: function (e) {
                ...
                if (this.isFormEmail) {
                    ...
                    formDataEmail.append('name', this.formEmail.campaign.name);
                    formDataEmail.append('template_id', this.formEmail.campaign.template_id);
                    formDataEmail.append('query_id', this.formEmail.campaign.query_id);
                    formDataEmail.append('subject', this.formEmail.campaign.subject);
                    formDataEmail.append('emailResponse', this.formEmail.campaign.emailResponse);
                    formDataEmail.append('sender', this.formEmail.campaign.sender);

                    boton.disabled = true;
                    this.messageAssign.text = 'Procesando la información al email, por favor espere...';

                    axios.post('/includes/segmentador/assignation/createCampaignEmail', formDataEmail, {
                        headers: {
                        ...
                        if(response.data.success){
                            ...
                            window.location.href="http://sinaptica-crm-dev.test/nuevo-email/campaña" // Dirigir a listado de campañas.
                        }
                    }).catch(error => {
                        console.log('Error ejecutar la función', error);
                    }).finally(() => {
            ...
            getTemplates: function () {
                axios.get('/includes/templates/getTemplates')
                    .then(response => {
                        this.formEmail.templates = response.data.items
                    })
                    .catch(error => {
            ...
            findTemplate: function () {
                axios.get('/includes/templates/getTemplate?id=' + this.formEmail.campaign.template_id)
                    .then(response => {
                        this.formEmail.templateSelected = response.data.item;
                        this.formEmail.customVariables = JSON.parse(this.formEmail.templateSelected.customVariables);
                    })
                    .catch(error => {
                        console.error('Error al cargar datos:', error);
                    })
