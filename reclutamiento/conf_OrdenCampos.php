<?php
    ...
    $objetoSession->crearVariableSession($array = array("idMenu" => "rec,conf_Excel"));
...
<body>
  <div id="container" class="effect mainnav-lg">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class='form-group'>
                                <label class='control-label'>Seleccione Contenedor:</label>
                            ...
                            <div class="list-group" id="FieldList">
                                <!--<a class="list-group-item draggable">Dapibus ac facilisis in</a>-->
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="../js/reclutamiento/conf_ordenCampos.js"></script>
</body>
</html>