<?php
	...
	{			
		...
		$objPHPExcel->getProperties()->setCreator("Soporte") //Autor
		 ->setLastModifiedBy("Soporte") //Ultimo usuario que lo modificó
		 ->setTitle("Reporte 11")
		...
		while ($fila = $resultado->fetch_array()) 
		{
			...
			$fechaGestion = $fila['0'];
			$horaGestion = $fila['1'];
			$q2 = "SELECT Tramo_Dias_Mora,Deuda,Saldo_Mora,Personalizado5,Cuenta,Id_Cedente FROM Deuda WHERE Rut = $rut AND Id_Cedente IN (45,44,48,49) GROUP BY Rut LIMIT 1";
