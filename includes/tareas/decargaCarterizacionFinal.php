...
$sqlCarterizacionFinal = $mysqli->query("SELECT * FROM disal.carterizacionFinal");
...
$writer->save('/home/DISAL/carterizacionMensual.xlsx');
shell_exec("cp /home/DISAL/carterizacionMensual.xlsx /var/www/html/reporte/");
