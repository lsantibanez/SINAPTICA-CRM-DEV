                ...
                <div id="page-content">
                        ...
                        <div class="col-lg-6">
                            <div class="panel" id="demo-panel-collapse" class="collapse in">
                                ...
                                <div class="panel-body ">
                                    <div class="col-sm-4">
                                        ...
                                        <?php echo $cedente2; ?>
                                            <select class="selectpicker" id="seleccione_tipo_busqueda"  name="tipo_estrategia" data-live-search="true" data-width="100%">
                                                ...
                                                <option value="2">Tripulaciones</option>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                foreach($tri as $row){
                                                    ...
                                                    $nombreTri = $row['nombre'];
                                                    echo "<option value='$idTri'>".$sucursal." - ".$nombreTri."</option>";
                                                }
                                                ?>
                                    ...
                                    <div id="busqueda_rut3">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <select class="selectpicker" id="rut_buscado3"  n data-live-search="true" data-width="100%">
                                                <option value="0">Seleccione Tipo Búsqueda</option>
                                                <?php
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="submit" class="btn btn-primary btn-block" value="Buscar" id="buscar_rut3">
                                            </div>
                                        </div>
                                    </div>
                                    <div id="busqueda_rut4">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <select class="selectpicker" id="rut_buscado4"  n data-live-search="true" data-width="100%">
                                                <option value="0">Seleccione Tipo Búsqueda</option>
                                                <?php
                                                foreach($clientes as $row){
                                                    $rutCliente = $row['rut'];
                                                    $nombreCliente = $row['nombre'];
                                                    echo "<option value='$rutCliente'>".$nombreCliente."</option>";
                                                }
                                                ?>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="submit" class="btn btn-primary btn-block" value="Buscar" id="buscar_rut4">
                                            </div>
                                        </div>
                                    </div>
                                </div> 
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel" id="demo-panel-collapse" class="collapse in">
                                <div class="panel-heading">
                                    <h3 class="panel-title bg-primary">Gestión</h3>
                                </div>
                                <div class="panel-body ">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker" id="clienteIn2"  data-live-search="true" data-width="100%">
                                                <option value="N/A">N/A</option>
                                                <?php
                                                foreach($clientes as $row){
                                                    $rut = $row['rut'];
                                                    $nombreCliente = $row['nombre'];
                                                    echo "<option value='$nombreCliente'>$nombreCliente</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker" id="tipificacionIn2"  name="tipificacionIn2" data-live-search="true" data-width="100%">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea id="observacionIn2" name="observacionIn2" class="form-control"></textarea>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel" id="demo-panel-collapse" class="collapse in">
                                <div class="panel-heading">
                                    <h3 class="panel-title bg-primary">Mis Gestiones</h3>
                                </div>
                                <div class="panel-body ">
