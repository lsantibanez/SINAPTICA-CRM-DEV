...
<input type="hidden" id="AccesoDirectoRut" value="<?php echo $AccesoDirectoRut; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select class="selectpicker" id="seleccione_tipo_busqueda"  name="tipo_estrategia" data-live-search="true" data-width="100%">
                                                ...
                                                <option value="1">Tripulaciones</option>
                            ...
                            <div class="panel" >
                                ...
                                <div class="panel-body">
                                    <div class="tab-content">
                                        ...
                                        <table id="llamadaSac" class="display" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>Telefono</th>
                                                    <th>Llamar</th>
                                            ...
                                            <tbody>
                                                <tr id='1'>
					                                <td class='text-sm'><input type='hidden' id='telefono1' value='229848152' name='telefono1'><input type='text' class='telefono_cambiar text6 telefono SoloNumeros' value='229848152'></td>
					                                <td class='text-sm'><button id='fono1' class='btn btn-success btn-icon icon-lg fa fa-phone Llamar'  value='Llamar'> </button> </td>
                                                </tr>
                                            </tbody>
                                        </table>
    ...
    <script src="../js/crm/sac.js"></script>
