...
$rut_consult = (isset($_POST['rut_a_consultar'])) ? $_POST['rut_a_consultar'] : '';
        ...
        <div class="boxed">
            <div id="content-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Modo Preview</li>
                </ol>
                <div id="page-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel" id="demo-panel-collapse" class="collapse in">
                                ...
                                <div class="panel-body ">
                                    ...
                                    <div id="busqueda_rut">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <input type="text" value="<?php echo $rut_consult; ?>" placeholder="Ingrese Rut" class="form-control" id="rut_buscado">
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-12" id="ProgressBar">
                        <!-- <div class="col-lg-12" style="text-align: center;">
                            <h5>Barra de Progreso de la Asignación</h5>
                        </div> -->
                        <div class="col-lg-10" style="padding-left:0px"><div class="progress progress-xl"><div class="progress-bar progress-bar-success"></div></div></div>
                        <div class="col-lg-2">
                            <div class="row">
                    ...
                    <div class="col-md-4" id="script_cobranza">
                        <div class="panel" id="demo-panel-collapse" class="collapse in">
                            ...
                            <div class="panel-footer" style="display:none" id="reloj">
                    ...
                    <div class="col-md-8" id="datos_cliente">
                        <div class="panel" >
                            <div class="panel-heading bg-primary">
                                <button id="storePersonaCrm" class="btn btn-success pull-left" style="margin-top:10px;margin-left:10px">Agregar Persona</button>
