                          ...
                          <!-- Inicio modificar mandante -->
                            <script id="modificarMandante" type="text/template">
                              <div class="row">
                                <div class="col-md-12">
                                  <form class="form-horizontal">
                                    <div class="row" id="EmpiezaEvaluacion" style="display: none;">
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          <div class="col-md-3">
                                          ...
                                          <div class="col-md-8">
                                             <div id="date-range">
                                                <div class="input-daterange input-group" id="datepicker">
                                                  <select name="evaluar" id="evaluar" class="selectpicker" data-width="100%"  title="Seleccione" data-live-search="true" data-width="100%">
