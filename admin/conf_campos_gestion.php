...
<body>
  <div id="container" class="effect mainnav-lg">
    ...
    <!--END NAVBAR-->
      <div class="boxed">
        ...
        <div id="content-container">
          ...
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <div id="page-title">
            <h1 class="page-header text-overflow">Campos gestión</h1>
          <!--Searchbox-->
          </div>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End page title-->
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Campos gestión</li>
          </ol>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End breadcrumb-->
          <!--Page content-->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-3" style="padding: 12px;">
                                    <button class="btn btn-block btn-success" id="CrearCampo">
                                        <i class="fa fa-plus"></i>&nbsp;&nbsp;Crear nuevo campo
                                    </button>
                                </div>
                            </div>
                            <div class="row">
        ...
        <script id="CampoTemplate" type="text/template">
            <input type="hidden" class="form-control" name='idCampo' id='idCampo'>
            <div class="row" style="padding: 10px 13px;">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
			        <div class="form-group">
                        ...
                        <select class="form-control selectpicker" title="Seleccione" data-live-search="true" multiple id="Cedente" name="Cedente">
                            <?php
                                $CedenteClass = new Cedente();
                                $Cedentes = $CedenteClass->getCedentesMandante($_SESSION['mandante']);
                                foreach((array) $Cedentes as $Cedente){
                                   echo "<option value='".$Cedente['idCedente']."'>".utf8_encode($Cedente['NombreCedente'])."</option>";
                                }
                            ?>
                        </select>
                    </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="selectpicker form-control" id="Respuesta_Nivel3" name="Respuesta_Nivel3" title="Seleccione" data-live-search="true" multiple></select>
                    </div>
                </div>
            </div>
        </script>
    ...
    <script src="../js/admin/conf_campos_gestion.js"></script>
</body>
</html>