...
$objetoSession->crearVariableSession($array = array("idMenu" => "modSup,conftramo"));
...
<body>
  ...
  <div id="container" class="effect mainnav-lg">
    ...
    <!--END NAVBAR-->
      <div class="boxed">
        ...
        <div id="content-container">
          ...
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <div id="page-title">
            <h1 class="page-header text-overflow">Mantenedor de Tramos</h1>
          <!--Searchbox-->
          </div>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End page title-->
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Mantenedor de Tramos</li>
          </ol>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End breadcrumb-->
          <!--Page content-->
          <!--===================================================-->
                ...
                <div class="row">
                    <div class="panel">
                        <div class="panel-heading">
                            <h2 class="panel-title">Mantenedor de Tramos</h2>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-3">
                                    <button style="margin: 10px 0;" id="AddTramo" class="btn btn-primary btn-block">Agregar Tramo</button>
                                </div>
                            </div>
                            <div class="row">
                                <table id="Tramos">
            ...
            <script id="AddTramoTemplate" type="text/template">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control SoloNumeros" name='Desde'>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Hasta:</label>
                            <input type="text" class="form-control SoloNumeros" disabled name='Hasta'>
                        </div>
                    </div>
                </div>
            </script>
    ...
    <script src="../js/cedente/conf_TramosCedentes.js"></script>
</body>
</html>