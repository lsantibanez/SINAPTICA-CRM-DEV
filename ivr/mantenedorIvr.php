...
$objetoSession->crearVariableSession($array = array("idMenu" => "adm,omnica,manIvr"));
...
<body>
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">Mantenedor Ivr</h1>
                </div>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End page title-->
                <!--Breadcrumb-->
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="#">Mantenedor Ivr</a></li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                <!--Page content-->
					    ...
					    <div class="col-lg-12">
					        <div class="panel">                                
                                <div class="panel-heading">
                                    <h2 class="panel-title">Horario Envío Ivr</h2>
                                </div>
    ...
    <!-- Consultas -->
    <script src="../js/ivr/mantenedorIvr.js"></script>
</body>
</html>