                     ...
                     "columnDefs": [
                      
                        {
                            ...
                            "render": function( data, type, row ) {
                                return "<div style='text-align: center;' id='" + data +"'><i style='cursor: pointer; margin: 0 5px;' class='fa fa-pencil-square-o btn btn-success btn-icon icon-lg modificar'></i><i style='cursor: pointer; margin: 0 5px;' class='fa fa-trash btn-danger btn btn-icon icon-lg eliminar'></div>";
                            }
                        }
                    ]
                }); 
