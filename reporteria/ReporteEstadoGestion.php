...
<html lang="es">
    ...
    <body>
                                                ...
                                                <div class="panel-body">
                                                    <div class="col-sm-6">
                                                        <div class="panel">
                                                            ...
                                                            <div class="panel-body">
                                                                <div id="ReportSaldos" style="height: 450px;"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="panel">
                                                            <div class="panel-heading bg-primary">
                                                                <h3 class="panel-title">Recuperos</h3>
                                                            </div>
                                                            <div class="panel-body">
                                                                <div id="ReportRecuperos" style="height: 450px;"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <script src="../js/reporte/EstadoGestion.js"></script>
