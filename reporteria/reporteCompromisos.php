...
$objetoSession->crearVariableSession($array = array("idMenu" => "gra,oper,compr"));
...
<body>
  ...
  <div id="container" class="effect mainnav-lg">
      ...
      <div class="boxed">
        ...
        <div id="content-container">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Compromisos Diarios</li>
          </ol>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End breadcrumb-->
          <!--Page content-->
                ...
                <div class="row">
                    <div class="panel">
                        <div class="panel-heading">
                            <h2 class="panel-title">Descargar Compromisos</h2>
                        </div>
    ...
    <script src="../js/reporteria/reporteCompromisos.js"></script>
</body>
</html>
