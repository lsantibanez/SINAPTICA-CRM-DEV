...
$objetoSession->crearVariableSession($array = array("idMenu" => "gra,oper,gest-est"));
...
<body>
  ...
  <div id="container" class="effect mainnav-lg">
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row" style="padding: 12px">
                                    <div class="col-md-3">
                                        <button class="btn btn-block btn-primary" id="Download">Descargar</button>
                                    </div>
                                </div>
                                <div class="row" style="padding: 12px">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">Gestiones:</label>
                                            <textarea id="Texto" class="form-control" rows="20" style="resize: none;"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="../js/reporteria/reporteGestionesEstructurado.js"></script>
</body>
</html>
