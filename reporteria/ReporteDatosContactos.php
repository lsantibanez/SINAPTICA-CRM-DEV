...
<html lang="es">
    ...
    <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Datos de Contactos</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                    <!--Page content-->
                                        ...
                                        <div class="row">
                                            <div class="panel">
                                                <div class="panel-heading bg-primary">
                                                    <h3 class="panel-title">Reporte de Datos de Contactos</h3>
                                                </div>
                                                <div class="panel-body">
                                                    <div class="col-sm-6">
                                                        <div class="panel">
                                                            ...
                                                            <div class="panel-body">
                                                                <div id="ReportFonos" style="height: 450px;"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="panel">
                                                            ...
                                                            <div class="panel-body">
                                                                <div id="ReportMails" style="height: 450px;"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <script src="../js/reporte/DatosContactos.js"></script>
