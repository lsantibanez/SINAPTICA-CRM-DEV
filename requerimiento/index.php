...
$objetoSession->crearVariableSession($array = array("idMenu" => "adm,omnica,req"));
    ...
    <!--END NAVBAR-->
      <div class="boxed">
        ...
        <div id="content-container">
          ...
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <div id="page-title">
            <h1 class="page-header text-overflow">Solicitud de Requerimiento</h1>
          <!--Searchbox-->
          </div>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End page title-->
                    ...
                    <div class="panel" id='sql'>
                      ...
                      <div >
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="form-group">
                              <textarea name="descripcion" id="descripcion" cols="100" rows="2" class="form-control"></textarea>
                          </div>
                      </div>
                    </div>
