...
$objetoSession->crearVariableSession($array = array("idMenu" => "gra,graf,smsEnviado"));
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">SMS Enviados</h1>
                </div>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End page title-->
                <!--Breadcrumb-->
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">SMS</a></li>
                    <li class="active"><a href="#">SMS Enviados</a></li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                <!--Page content-->
                ...
                <div id="page-content">
					<div class="row">
					    ...
					    <div class="col-lg-12">
					        <div class="panel">                                
                                <div class="panel-heading">
                                    <h3 class="panel-title">SMS Enviados</h3>
                                </div>
...
<!-- Consultas -->
    <script src="../js/email/smsEnviados.js"></script>
</body>
</html>