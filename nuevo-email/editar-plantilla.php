                    ...
                    axios.get(`/includes/new_email/getTemplate?id=${this.id}`)
                        .then((response) => {
                            if (response.data.success) {
                                ...
                                this.template.html_content = templateData.html_content

                                try {
                                    this.template.json_content = JSON.parse(templateData.json_content);
                                } catch (e) {
                                    console.error('Error al parsear json_content:', e);
                                    this.template.json_content = {};
                                }
                                if (this.template.json_content) {
                                    unlayer.loadDesign(this.template.json_content);
                                }
                            }
                        })
                        .catch(error => {
                            ...
                            axios.put('/includes/new_email/updateTemplate', {
                                ...
                                .then((response) => {
                                    if (response.data.success) {
                                        ...
                                        window.location.href = "http://sinaptica-crm-dev.test/nuevo-email/plantilla";
                                    } else {
