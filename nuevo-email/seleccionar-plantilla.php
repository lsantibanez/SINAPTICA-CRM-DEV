                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row row-cols-auto">
                                        <div class="col mb-3" v-for="(item, index) in customVariables" :key="index">
                                            <span class="badge bg-primary p-3">{{ item }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="container-fluid text-center mt-30">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-4" v-for="(template, index) in paginatedItems"
                                                 :key="index">
                                                <div class="card">
                                                    <div class="card-header p-0">
                                                        <img :src="template.urlPreview" class="card-img-top"
                                                             alt="Vista previa" @click="openModal(template.urlPreview)"
                                                    ...
                                                    <div class="card-footer">
                                                        <code>Nombre de la plantilla: </code>
