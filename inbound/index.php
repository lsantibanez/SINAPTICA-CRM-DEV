<?PHP
    ...
    $crm = new crm();
    $objetoSession->crearVariableSession($array = array("idMenu" => "crm,ejec,inbound"));
      ...
      <!--END NAVBAR-->
        <div class="boxed">
            <div id="content-container">
                <div id="page-title">
                    <h1 class="page-header text-overflow">Modo Inbound</h1>
                </div>
                <ol class="breadcrumb">
                    <li><a href="#">Gestión</a></li>
                    <li><a href="#">Ejecutivos</a></li>
                    <li class="active">Modo Inbound</li>
                </ol>
                <div id="page-content">
                    <div class="row">
                        <div class="panel" id="demo-panel-collapse" class="collapse in">
                            <div class="panel-heading">
                                <h3 class="panel-title bg-primary"><i></i>Inbound</h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                        <label class="control-label" for="ColaInbound">Cola Inbound</label>
