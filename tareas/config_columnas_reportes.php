...
$objetoSession->crearVariableSession($array = array("idMenu" => "adm,gestion,conf_aRptDial"));
    ...
    <!--END NAVBAR-->
      <div class="boxed">
        ...
        <div id="content-container">
          ...
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <div id="page-title">
            <h1 class="page-header text-overflow">Configuración de columnas reportes</h1>
          <!--Searchbox-->
          </div>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End page title-->
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Configuración de columnas reportes</li>
          </ol>
          <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
          <!--End breadcrumb-->
          <!--Page content-->
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-3" style="padding: 12px;">
                                        <button id="cambiaMandante" class="btn btn-primary btn-block">Seleccione empresa</button>
                                    </div>
                                    <div class="col-md-6" style="padding: 12px;">&nbsp;</div>
                                    <div class="col-md-3" style="padding: 12px;">
                                        <button id="AddColumna" class="btn btn-success btn-block">
